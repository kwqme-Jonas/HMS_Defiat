                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded-full" src="img/pg.jpg" alt="" />
                                    </div>

                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Ruth Amiri</div>
                                        <div class="text-sm leading-5 text-gray-500">amiri@test.com</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500">Student</td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded-full" src="img/c.jpg" alt="" />
                                    </div>

                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Mary Bashe</div>
                                        <div class="text-sm leading-5 text-gray-500">bashe@test.com</div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Mavis Doe</div>
                                        <div class="text-sm leading-5 text-gray-500">mavis@test.com</div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Jonas Donkor</div>
                                        <div class="text-sm leading-5 text-gray-500">donkor@test.com</div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Ella Monae</div>
                                        <div class="text-sm leading-5 text-gray-500">monae@test.com.com</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-sm leading-5 text-gray-500">john@test.com</div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Prince Ocansey</div>
                                        <div class="text-sm leading-5 text-gray-500">prince@test.com</div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900">Amoako Isaac</div>
                                        <div class="text-sm leading-5 text-gray-500">isaac.a@test.com</div>
                                    </div>
                                </div>
                            </td>
